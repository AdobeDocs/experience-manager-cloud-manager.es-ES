...
>[!NOTE]
>
>Póngase en contacto con su ingeniero de éxito del cliente (Customer Success Engineer, CSE) para habilitar esta función.
...
* La copia de contenido para la topología basada en el almacén de datos de la nube solo se puede realizar cuando los entornos de origen y destino están en el mismo proveedor de la nube.
