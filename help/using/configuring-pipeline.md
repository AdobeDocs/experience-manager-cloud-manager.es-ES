...
seo-description: 'Antes de empezar a implementar el código, debe configurar la configuración de la canalización desde el Administrador de nube de AEM. '
...
>[!CAUTION]
>
>La canalización no se puede configurar hasta que el repositorio de Git tenga al menos una ramificación y se complete la instalación [del](setting-up-program.md) programa.
...
1. Aparece la pantalla **Configurar tubería** .
   ...
   El asistente de tres pasos le permite configurar su entorno **de ramas**, **entornos** y **pruebas** .
