...
description: Estas son las notas de la versión de Cloud Manager 2023.10.0.
...
La fecha de la versión de [!UICONTROL Cloud Manager] 2023.10.0 es el 5 de octubre de 2023. El próximo lanzamiento está planificado para el 2 de noviembre de 2023.

## Novedades {#what-is-new}

* AEM El rol **Administrador de implementación** puede [configurar un conjunto de rutas de contenido que se invalidarán o vaciarán de la caché de Dispatcher de la cuando se ejecute una canalización sin producción](/help/using/non-production-pipelines.md).
