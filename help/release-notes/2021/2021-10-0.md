...
description: Obtenga más información sobre la versión de Cloud Manager 2021.10.0.
...
# Notas de la versión 2021.10.0 de Cloud Manager {#release-notes-for}

En la siguiente sección se describen las notas generales de la versión 2021.10.0 de [!UICONTROL Cloud Manager].
...
La fecha de lanzamiento de la versión 2021.10.0 de [!UICONTROL Cloud Manager] es el viernes, 14 de octubre de 2021.
...
* Cuando la lectura de datos de los sistemas internos se introduce correctamente, es posible que los datos no relacionados proporcionados por los CSE (ingeniero de éxito del cliente) de Adobe no se reflejen correctamente en Cloud Manager.
