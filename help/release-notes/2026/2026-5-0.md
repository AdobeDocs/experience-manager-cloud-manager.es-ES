...
Un nuevo modelo de compilación compila solo los módulos modificados (en lugar de todo el repositorio) mediante el almacenamiento en caché de nivel de módulo, lo que reduce los tiempos de compilación. Se aplica a las canalizaciones Calidad del código y Pila completa.
