...
La consola **Mis programas** proporciona una descripción general de todos los programas a los que tiene acceso en la organización seleccionada. Consta de varias partes.
...
Hay dos barras de herramientas.

#### Encabezado de Cloud Manager {#cloud-manager-header}

El primero es el encabezado de Cloud Manager. El encabezado siempre está visible mientras utiliza Cloud Manager. Es una ubicación central que proporciona acceso a la configuración y a la información que se aplican a todos los programas de Cloud Manager.
...
La barra de herramientas de programas proporciona vínculos para cambiar entre programas de Cloud Manager y acciones relevantes para el contexto.
...
| 3 | *`Dynamic action button`* | El botón de acción ofrece acciones apropiadas para el contexto en las que puede hacer clic, como **Agregar programa** (visto en el ejemplo anterior) o agregar un dominio. |
...
Si está empezando la configuración de su organización, hay instrucciones sobre los pasos siguientes o los recursos de documentación.
...
Al hacer clic en el icono ![Más, los puntos suspensivos](https://spectrum.adobe.com/static/icons/workflow_18/Smock_More_18_N.svg) proporcionan acceso a acciones adicionales que puede realizar en el programa.
...
La sección de vínculos rápidos proporciona acceso a recursos útiles relacionados.
...
**Información general del programa** proporciona acceso a todos los detalles de un programa de Cloud Manager. Al igual que **Mis programas**, consta de varias partes.
...
El encabezado de Cloud Manager tiene un menú desplegable ![Mostrar icono del menú](https://spectrum.adobe.com/static/icons/workflow_18/Smock_ShowMenu_18_N.svg) que se abre automáticamente para mostrar las pestañas navegables de Información general del programa.

Haga clic en ![Mostrar icono de menú](https://spectrum.adobe.com/static/icons/workflow_18/Smock_ShowMenu_18_N.svg) para ocultar las fichas.

#### Barra de herramientas del programa {#program-toolbar-2}

La barra de herramientas del programa sigue proporcionando acceso para cambiar a otros programas rápidamente, pero además proporciona acceso a acciones apropiadas para el contexto, como agregar y editar el programa.

![Barra de herramientas del programa](assets/cloud-manager-program-toolbar.png)

Además, si oculta las fichas mediante ![Mostrar icono de menú](https://spectrum.adobe.com/static/icons/workflow_18/Smock_ShowMenu_18_N.svg), la barra de herramientas puede mostrar la ficha en la que se encuentra actualmente.

### Pestañas del programa {#program-tabs}

Cada programa tiene muchas opciones y datos asociados. Estos datos están organizados en pestañas para simplificar la navegación del programa. Las pestañas proporcionan acceso a lo siguiente:
...
* [Actividad de copia de contenido](/help/using/content-copy.md): actividades de copia de contenido
...
Para ocultar las fichas, usa ![Mostrar icono de menú](https://spectrum.adobe.com/static/icons/workflow_18/Smock_ShowMenu_18_N.svg) en el [encabezado de Cloud Manager](#cloud-manager-header-2).

### Llamada a la acción {#cta}

La sección de llamada a la acción le proporciona información útil según el estado del programa. Para un programa nuevo, verá los pasos siguientes que se ofrecen y un recordatorio de una fecha de lanzamiento [establecida durante la creación del programa](/help/getting-started/program-setup.md).

Para un programa activo, se muestra el estado de la última implementación, con vínculos para obtener detalles e iniciar una nueva implementación.
